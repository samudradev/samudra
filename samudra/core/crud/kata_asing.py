...
def get_kata_asing_minimum_info(where: Any, limit: Optional[int] = None) -> List[models.KataAsing]:
...
def get_kata_asing_by_id(kata_asing_id: int, limit: Optional[int] = None) -> List[models.KataAsing]:
    return get_kata_asing_minimum_info(where=(models.KataAsing.id == kata_asing_id), limit=limit)
