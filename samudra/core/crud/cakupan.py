...
def get_cakupan_minimum_info(where: Any, limit: Optional[int] = None) -> List[models.Cakupan]:
...
def get_cakupan_by_id(cakupan_id: int, limit: Optional[int] = None) -> List[models.Cakupan]:
    return get_cakupan_minimum_info(where=(models.Cakupan.id == cakupan_id), limit=limit)
